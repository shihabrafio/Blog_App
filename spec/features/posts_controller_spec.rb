...
describe 'posts', type: :feature do
  describe '#index' do
    before(:each) do
      @user = User.create(name: 'Rafio', bio: 'This is user page', photo: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?ixlib=rb-4.0.3&ixid=
# M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=870&q=80')
      ...
      @comment3 = Comment.create(text: 'Great shot, Gakii!', author_id: @user.id, post_id: @post1.id)
  ...
  describe '#show', type: :feature do
    before(:each) do
      @user = User.create(name: 'Gakii', bio: 'Teacher from USA', photo: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=870&q=80')

      @user1 = User.create(name: 'Rafio', bio: 'This is user page', photo: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=870&q=80')

      @post = Post.create(title: 'Adventure', text: 'Checkout this waterfall', author_id: @user.id)

      @comment = Comment.create(text: 'Great shot, Gakii!', author_id: @user1.id, post_id: @post.id)
    ...
    it 'displays posts comments, comments author' do
      expect(page).to have_content('Rafio: Great shot, Gakii!')
    end
  end
end
